...
class PSO():
    ...
    def __init__(self):
        ...
        self.num_freqs = 1 #set to 1 for just 8.2 GHz, set to 85 for all frequencies etc
        self.increment = 0.05e9
    ...
    def calculate_fitness(self, frequency):
        ...
        for j in range(0, self.num_particles):
            ...
            self.first_layer_e = (data[self.first_layer][1]+(self.j*data[self.first_layer][2]))
            ...
            for i in range(1, self.num_layers):
                ...
                self.layer_e = (data[self.layer][1]+(self.j*data[self.layer][2]))
